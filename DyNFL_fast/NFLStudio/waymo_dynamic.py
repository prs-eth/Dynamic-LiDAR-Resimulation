...
class WaymoDynamic(Dataset):
    ...
    def load_vehicle_data(self, to_replace_index=3, to_load_index=13, context_name_other='13271285919570645382_5320_000_5340_000'):
        ...
        tsfm = torch.load(f"/scratch/hanfeng/LidarSimStudio/NFLStudio_dynamic_raydrop/NFLStudio/vehicle_data/{context_name_other}/tsfm_{to_load_index}.pt")
        extent = torch.load(f"/scratch/hanfeng/LidarSimStudio/NFLStudio_dynamic_raydrop/NFLStudio/vehicle_data/{context_name_other}/extent_{to_load_index}.pt").cpu().item()
        ...
        aabb_shift =  (aabb[:3] - self.aabb_vehicle[to_replace_index][:3])

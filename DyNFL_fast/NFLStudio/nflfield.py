...
class NFLField(Field): ## with SDF
    def __init__(self,
        ...
        self.sdf_net = tcnn.Network(
            n_input_dims=self.n_output_dim,
        ...
        self.intensity_net = tcnn.Network(
            n_input_dims=self.geo_feat_dim + self.encoder_dir.n_output_dims,
            n_output_dims=1,  # intensity, ray_drop, second_return
            network_config={
                "otype": "FullyFusedMLP",
                "activation": "ReLU",
                "output_activation": "None",
                "n_neurons": 64,
                "n_hidden_layers": num_layers_reflectance - 1 
            },
        )

        self.ray_drop_net = tcnn.Network(
            n_input_dims=self.geo_feat_dim + self.encoder_dir.n_output_dims,
            n_output_dims=2,  
            network_config={
                "otype": "FullyFusedMLP",
